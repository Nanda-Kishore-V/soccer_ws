...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/install)
...
if(NOT "/home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/devel/include " STREQUAL " ")
  set(image_processing_INCLUDE_DIRS "")
  set(_include_dirs "/home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'nanda <nandakishore12111996@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/src/image_processing/${idir}'.  Ask the maintainer 'nanda <nandakishore12111996@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/devel/lib;/home/nanda/Documents/RMI/SoccerBots/codes/soccer_ws/devel/lib;/home/nanda/Documents/robotics_lab/robot_sim/devel/lib;/home/nanda/Documents/RMI/ROS/gazebo_tutorial_ws/devel/lib;/opt/ros/kinetic/lib)
